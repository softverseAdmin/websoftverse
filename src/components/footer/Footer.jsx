...
<>
  <footer id='footer'>
    <div className='footer_cta-sec'>
      <div className='footer_cta-sec-inner'>
        ...
        <section className='footer_application-area'>
          <h2 className='footer_contact-area_ttl'>ネットからのお申し込み</h2>
          <p className='footer_contact-area_btn'>
    ...
    <div className='footer-inner'>
      <a href='#header' className='page-top' > </a>
      ...
      <ul className='footer_sns-link'>
        <li className='sns-twitter'>
          <a href='https://twitter.com/syodorin'>
            <img src='https://syodorin.org/wp/wp-content/themes/gyokakuji/assets/images/common/footer-twitter.svg' alt='Twitter' />
            </a>
        </li>
        <li className='sns-youtube'>
          <a href='https://www.youtube.com/@user-wi8zs7lh3u'>
            <img src='https://syodorin.org/wp/wp-content/themes/gyokakuji/assets/images/common/footer-youtube.svg' alt='YouTube' />
            </a>
        </li>
      </ul>

      <div className='footer_bnr-link_wrapper'>
        <p className='footer_bnr-link'><a href='/zou/'><img src='https://syodorin.org/wp/wp-content/themes/gyokakuji/assets/images/common/footer-zou-banner.png ' alt='蔵 zou' /></a></p>
      </div>

      <div className='footer_logo-area'>
        <a href='/' className='footer_logo'><img src='https://syodorin.org/wp/wp-content/themes/gyokakuji/assets/images/common/footer-logo.svg' alt='唱導林 - 日蓮宗 行覚寺' /></a>
        <p className='footer_address'>〒545-0021<br />大阪府大阪市阿倍野区阪南町1-41-20</p>
        <p className='footer-tel'>TEL : 06-6621-4930</p>

        <ul className='footer_logo-area_link-list'>
          <li className='snav01'><a href='/privacy/'>プライバシーポリシー</a></li>
          <li className='snav02'><a href='/terms/'>特定商取引法に基づく表記</a></li>
        </ul>
      </div>
      
    </div>
    <p className='footer_copyright'><small>© 2023 Gyokakuji.</small></p>
  </footer>
</>
  )
}
